...
clutch_scores_by_distance.to_csv("ffnn_results/clutch_scores_by_distance.csv", index=False)
pas_kick.to_csv("ffnn_results/baseline_by_distance.csv", index=False)
...
clutch_scores_by_score_diff.to_csv("ffnn_results/clutch_scores_by_score_difference.csv", index=False)
pas_score.to_csv("ffnn_results/baseline_by_score_difference.csv", index=False)